document.addEventListener("DOMContentLoaded", () => {
  ...
  app.innerHTML = `
    <div class="left-column">
      <h2>Who I Am</h2>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a semper sapien.</p>
      <p>Fusce ullamcorper, urna sed sodales tristique, lorem nulla pharetra mi, ac fermentum nulla nisl eu mauris.</p>
    ...
    <div class="right-column">
      <h2 class="lang-label">Languages:</h2>
      <div class="icons-circle">
        <img src="python.png" alt="Python" class="circle-icon">
        <img src="css-3.png" alt="CSS" class="circle-icon">
        <img src="js.png" alt="JS" class="circle-icon">
        <img src="html.png" alt="HTML" class="circle-icon">
        <img src="sql.png" alt="SQL" class="circle-icon">
        <img src="github.png" alt="GitHub" class="circle-icon">
      </div>
    </div>
  `;
