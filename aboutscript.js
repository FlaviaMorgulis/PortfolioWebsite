  ...
  app.innerHTML = `
    <div class="content-wrapper">
      <div class="left-column">
        <h2>About Me</h2>
        <p>
          Versatile professional with a background in music, small business management,
          and customer relationship management, now transitioning into software development.
          Combines strong problem-solving skills, technical learning, and a passion for building
          digital solutions to create impactful, user-focused software. Experienced in managing
          operations, marketing, and client engagement, bringing a unique perspective to development
          projects.
        </p>
        <div class="button-container">
          ...
          <div>
            ...
            <div class="cv-download" style="margin-top:15px;">
              <h3>Download CV:</h3>
              <a href="FlaviaMorgulisCV.pdf" download class="cv-link" aria-label="Download CV">
                <svg viewBox="0 0 24 24" width="24" height="24" style="vertical-align: middle;">
                  <path fill="#39393a" d="M6 2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6H6zm7 1.5V8h5.5L13 3.5zM6 4h6v5a1 1 0 0 0 1 1h5v10a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z"/>
                </svg>
              </a>
            </div>
          </div>
